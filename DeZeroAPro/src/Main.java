public class Main {
	...
	public static void main(String[] args) {
		...
		try {
		v = new Ville("Rennes", -12_000_000,"France");
		System.out.println(v.toString());
		System.out.println(v.getCategorieNbH());
		System.out.println(v.nomVille);
		System.out.println(v.nbreHabitants);
		System.out.println(v.nomPays);
		}
...
/**TODO OU DONC SE TROUVE LA POSSIBILITE DE CREER UN PACKAGE*/
/*
...
Capitale cap = new Capitale("Paris",6789567,"France", "Tour Effeil");
		System.out.println("Appel de la méthode décris-toi de la classe fille Capitale "+ cap.decrisToi());
		*/